...
export const ZONE_SETTINGS: SettingConfig[] = [
	...
	},
	{
		...
		description: 'Time period a visitor is allowed access before being challenged again'
	},
	{
		id: 'browser_check',
	...
	// Speed
	{
		...
		category: 'speed',
		type: 'toggle',
		description: "Speed up page load for visitor's HTTPS traffic with Brotli compression"
	},
	{
		id: 'early_hints',
		label: 'Early Hints',
